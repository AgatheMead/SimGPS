...
class caCode:
    ...
    def generate_ca_signal(self, duration, t0=0, phase0=0, doppler=0, doppler_drift=0, fs=sys_.fs, k=sys_.k_ca):
        '''
        ...
        # f_d = k * doppler, where k is carrier aiding factor
        # dfd = k * doppler_drift
        phase = t * (sys_.f_ca + k * (doppler + doppler_drift * t)) + phase0
...
if __name__ == '__main__':
    ...
    auto_corr.start('PRN' + str(sv1), 'PRN' + str(sv2), 'auto-correlation', save_gif, 'ca_code_auto')
